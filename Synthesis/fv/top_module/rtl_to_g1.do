set log file fv/top_module/rtl_to_g1.log -replace
...
vpx read guide file fv/top_module/rtl_to_g1.ovf
...
write hier_compare dofile fv/top_module/hier_rtl_to_g1.do \
...
run hier_compare fv/top_module/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
